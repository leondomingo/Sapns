...
from neptuno.util import strtobool
...
def make_app(global_conf, full_stack=True, **app_conf):
    ...
    # SSL
    if strtobool(app_conf.get('app.use_ssl', 'false')):
        from sslonlylogin import SSLOnlyLoginMiddleware
        app = SSLOnlyLoginMiddleware(app)
