...
i<l;i++){var col=cols[i];var wd=col.width;if(!wd){wd=self.default_.col_width}g_table+='<td class="sp-col-title" style="width: '+wd+'px;">'+col.title+"</td>"
...
g.search(g.q)})}this.append(g_content+'<div class="actions" style="clear: left; position: relative;"></div>'+g_table+g_pager+"</div>");
