...
var o=p.cols;if(typeof(o)=="function"){o=o()}var t=o.length,e=23;for(var x=0;x<t;
x++){var d=o[x];e+=d.width}e+=t*5;var y='<div class="sp-grid" style="width: '+(e+15)+'px;">';
...
}console.log(1);y+='<div class="sp-grid-cell" title="'+(x+1)+'" style="width: 23px;'+w+'"><input class="sp-grid-rowid" type="checkbox" id_row="'+f[0]+'"></div>'
