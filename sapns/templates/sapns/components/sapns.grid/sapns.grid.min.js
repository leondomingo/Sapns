...
var P='<div class="sp-grid" style="width:'+(w+5)+'px">';var p='<div class="sp-grid-row" style="width:'+(w+10)+'px">';
...
O<G;O++){var x=T[O];var r='<div class="sp-grid-row" style="width:'+(w+10)+'px">';
if(!E.hide_check){var N="";if(O==G-1){N="border-radius:0 0 0 5px"}r+='<div class="sp-grid-cell" title="'+x[0]+'" style="width:23px;'+N+'"><input class="sp-grid-rowid" type="checkbox" id_row="'+x[0]+'"></div>'
