...
}if(typeof(n.actions)==="function"){n.actions=n.actions()}var h=[{id:"csv",title:"CSV",url:"{{tg.url('/dashboard/to_csv/')}}"},{id:"excel",title:"Excel",url:"{{tg.url('/dashboard/to_xls/')}}",func_name:"to_xls",export_url:"{{tg.url('/dashboard/to_xls_/')}}",modal:true}];
...
g("#sp-grid-export-dialog").html(K.content).dialog({title:I.title,modal:true,resizable:false,width:I.width||700,height:I.height||"auto",buttons:{"{{_('Ok')}}":function(){if(!J){J=true;
window[I.func_name](function(){J=false},function(){J=false})}},"{{_('Cancel')}}":function(){if(!J){g("#sp-grid-export-dialog").dialog("close")
