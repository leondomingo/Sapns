...
var d='<div class="sp-grid-row">\n';if(!t.hide_check){d+='<div class="sp-col-title" style="width: 23px;"><input class="sp-grid-select-all" type="checkbox"/></div>\n'
...
}}b("#"+g.name+" .sp-grid-cell").live("click",function(m){if(b(this).attr("clickable")=="true"){b("#"+g.name+" .sp-grid-select-all").attr("checked",false);
var l=b(this).parent().find(".sp-grid-rowid");b("#"+g.name+" .sp-grid-rowid").each(function(){var n=m.ctrlKey||m.metaKey;
if(b(this)!=l&&!g.multiselect&&!n){b(this).attr("checked",false)}});if(l.attr("checked")==true){l.attr("checked",false)
}else{l.attr("checked",true)}}});function i(n,o){var l="";if(o!="_blank"){var l=g.url_base+"?q="+encodeURI(g.q).replace("-","%2D","g").replace('"',"%22","g").replace("+","%2B","g").replace("#","%23","g")+"&rp="+g.rp+"&pag_n="+g.pag_n+"&ch_attr="+g.ch_attr+"&parent_id="+g.parent_id
