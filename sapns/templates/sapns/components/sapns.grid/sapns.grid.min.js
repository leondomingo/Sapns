...
g.ajax(h)}else{g("#"+l.name+" .actions").html(l._loadActions(l.actions))}}g("#"+l.name+" .sp-grid-cell").live("click",function(q){if(g(this).attr("clickable")=="true"){g("#"+l.name+" .sp-grid-select-all").attr("checked",false);
