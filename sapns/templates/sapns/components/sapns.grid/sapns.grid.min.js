...
});b("#"+g.name+" .delete_inline").live("click",function(m){var n=b(this).parent().parent().parent().find(".sp-grid-rowid").attr("id_row");
var l=g.getAction("delete");g.std_delete([n],l.url)});b("#"+g.name+" .docs_inline").live("click",function(l){h(b(this),"docs")
