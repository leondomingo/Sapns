...
g(this).dialog("close");if(M){M()}},"{{_('Cancel')}}":function(){g(this).dialog("close")
...
g(this).dialog("close")},"{{_('Close')}}":function(){if(g(".sp-grid-filter-changed").length){g(".sp-grid-filter-changed").removeClass("sp-grid-filter-changed");
