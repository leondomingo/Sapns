...
}}}if(self.exportable){g_actions+='<div id="grid-export_'+self.name+'" style="position: absolute; background-color: none; height: 25px; right: 0px;"><select id="select-export" class="sp-button sp-grid-action" style="height: 20px;"><option value="">({{_("Export")}})</option><option value="csv">CSV</option><option value="excel">Excel</option></select></div>'
