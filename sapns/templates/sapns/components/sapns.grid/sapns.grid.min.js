...
set(this,"hide_id",false);set(this,"default_",{});set(this.default_,"col_width",60,this.default_);
...
}if(typeof(act.type)==="string"){var a='<div style="float: left;">';a+='<button class="sp-button sp-grid-action standard_action"  title="'+act.url+'" url="'+act.url+'" action-type="'+act.type+'" require_id="'+req_id+'" >'+act.title+"</button></div>";
