...
}self.search(q,true,arg3)}else{if(arg1=="getSelectedIds"){return self.getSelectedIds()
}else{if(arg1=="setRp"){self.rp=arg2;$("#"+self.name+" .sp-grid-rp [value="+arg2+"]").attr("selected",true)
}}}}}}return this}})(jQuery);