...
var Q={};Q[U.param_name]=G;Q[U.param_name+"$"]=JSON.stringify(H);var B="{{_('Ok')}}";
if(U.button_title){B=U.button_title}var A=true;if(U.refresh!==undefined){A=U.refresh
}if(U.extra_params!==undefined){for(ep in U.extra_params){Q[ep]=U.extra_params[ep]
...
return}}else{if(J.length>0){P.type.f(J[0],J)}else{P.type.f()}}}}function p(D,F,E,B){var A=r.getAction(F);
if(typeof(D)!=="number"){var G=D.parent().parent().find(".sp-grid-rowid").attr("id_row")*1
