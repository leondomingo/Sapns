...
}if(typeof(n.actions)==="function"){n.actions=n.actions()}var h=[{id:"csv",title:"CSV",url:"{{tg.url('/dashboard/tocsv/')}}"},{id:"excel",title:"Excel",url:"{{tg.url('/dashboard/toxls/')}}"}];
...
var S=g(".sp-grid-filter-name[grid-id="+y+"]").val().replace(/[^A-Za-z0-9_]/g,"_");
