...
if(typeof(i.rc_title)=="function"){l=i.rc_title()}b("#dialog_"+i.name).dialog({title:l,width:i.dialog.width,height:i.dialog.height,resizable:false,modal:true,buttons:{"{{_('Ok')}}":function(){var m=b("#dialog_"+i.name+" .sapns_grid").sapnsGrid("getSelectedIds")[0];
