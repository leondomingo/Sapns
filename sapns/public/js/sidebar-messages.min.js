...
$(d).appendTo("body")}a.show=function(e){var g=$.extend(true,{id:"sbm-message_"+Math.floor(Math.random()*99999),hide_after:5000,styles:"sbm-message-std"},e);
...
}if(typeof(g.hide_after)==="number"&&g.hide_after>0){setTimeout(function(){a.hide({id:g.id})
},g.hide_after)}return g.id};a.hide=function(e){var f=$.extend(true,{},e);var g=$("#"+f.id).length>0;
for(id in a.messages){if(id===f.id){delete a.messages[id]}}$("#"+f.id).fadeOut("slow",function(){$("#"+f.id).remove();
