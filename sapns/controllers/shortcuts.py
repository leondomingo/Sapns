...
class ShortcutsController(BaseController):
    ...
    def edit(self, **kw):
        ...
        if id_shortcut:
            ...
            for cls in dbs.query(SapnsClass).order_by(SapnsClass.title):
                ...
                if ROLE_MANAGERS not in roles and not SapnsPrivilege.has_privilege(user_id, cls.class_id):
                    continue
    ...
    def class_permissions(self, **kw):
        ...
        for p in dbs.query(SapnsPermission).\
            ...
            if ROLE_MANAGERS not in roles and not user.has_permission(p.permission_name):
                continue
